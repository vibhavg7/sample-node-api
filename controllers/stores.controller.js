...
exports.fetchAllOngoingOrders = function (req, res) {
    pool.getConnection(function (err, dbConn) {
        dbConn.query("SELECT o.order_id ,o.total_item_count,o.total_amount AS 'order_amount',o.added_date AS 'order_placing_date',s.store_name  FROM grostep.orders o inner join stores s on o.store_id = s.store_id where o.store_id  = ? and o.order_merchant_status BETWEEN 2 AND 3;",req.params.storeId, function (err, ongoingorders) {
            if (err) {
                res.json({
                    status: 400,
